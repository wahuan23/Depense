...
<body>
    ...
    <form action="<?php echo base_url('home/insertNewDepense'); ?>" method="post">
        ...
        <div class="paye">
        <p>Payé:</p>
            <p><?php echo number_format($payer, 0, '', ' '); ?> Ar</p>
        </div>

        <div class="reste">
        <p>reste:</p>
            <p><?php echo number_format( $reste=$payer - $overall_total, 0, '', ' '); ?>Ar </p>
        </div>
        <p> <a href="<?php echo base_url() . 'home/print/' . $overall_total ?>">Telecharger PDF</a></p>
    </form>
